questions = {
    ...
    '在国内可以访问一亩三分地吗？': 'instant.1point3acres.cn',
    ...
    '什么样的内容会得到其他用户的大量加分？': '这些都包括。',
    '急着求职了，想看帖子，如何可以快速获得积分？': '这些都可以',
    '关于论坛通行证的说法，哪个最正确？': '以上都正确',
    '如果希望发帖讨论和室友/邻居的关系，应该发在哪个版？': '人际',
    '有的帖子一看就不是论坛常见人群发的，应该如何回帖？': '默默关掉，不回帖',
    '抖包袱版存在的目的是': '让工资信息透明化，帮助有需求的人们更好的 negotiate 到最大的包',
    '给自己发的帖子添加到相关的热门话题，哪些说法是错误的？': '可能会被扣分，视情况，最多扣 10 分',
    '遇到特别奇葩的帖子，以下哪些做法是错误的？': '回帖：肯定是气氛组在冲业绩',
    '如果焦虑，抑郁，不想干活，觉得无趣，想吐槽，可以在哪个版发帖？': '心理健康',
    '按地区发帖和浏览有哪些好处？': '可以更好的获取周围地区的分类信息',
    '为什么有时候被警告会造成禁言，有时候又不会？': '累计警告超过一定数量后，会自动被禁言 N 天',
    '求购或者出手某专业复习资料': '跳蚤市场',
    '如果希望找人一起打球，应该发在哪个版': '玩友募集',
    '跨区发帖后，会有什么结果？': '这些都正确',
    '如果希望招人加入family plan，或者加入别人的 plan，应该发在哪个版': '跳蚤市场',
    '在论坛下载的附件有密码怎么办？':'关注一亩三分地公众号，获取解压密码',
    '给自己发的帖子添加到无关的热门话题，哪些说法是正确的？': '可能被扣分，视情况，最多扣 10 分',
    '关闭帖子': '这些都正确',
}
